...
public class adminHome  extends JFrame implements ActionListener{
    JLabel l1 = new JLabel("Pesquisa por nome ou Email"),l2;
    JButton btn1 = new JButton("Pesquisar"), btn2 = new JButton("Limpar"), bt3 = new JButton("logout");
    ...
    public adminHome() throws HeadlessException {
        ...
        bt3.setBounds(900, 1, 80, 20);
        bt3.addActionListener(this);
        tb1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"nome", "email", "Qestao Segura","Resposta", "Endereco", "status", "Sexo", "Nr telefone"},
            },
            new String [] {
                 "nome", "email", "Qestao Segura","Resposta", "Endereco", "status", "Sexo", "Nr telefone"
            }
        ...
        //-------------------------------------------
        tela.add(l1); tela.add(t1);tela.add(btn1);tela.add(btn2);tela.add(tb1);tela.add(bt3);
        //-------------------------------------------
