...
public class Signup extends JFrame implements ActionListener {
    ...
    CRUD  crud = new CRUD();
    String[]gd = {"M","F"};
    String[]qt = {"Qual seu nome?", "Cor Favorita?", "Onde nasceu?","seu pet?"};
    //
    ...
    public Signup() throws HeadlessException {
        super("Cadastro de Atendendes");
        Container tela = getContentPane();tela.setBackground(Color.WHITE);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == btn1){
            ...
            System.out.println(msg = "Voltar  a login");
            setVisible(false);
            new login();
            
        }else if (e.getSource() == btn3){
            System.out.println(msg = "Voltar  a Esqueci senha");
            setVisible(false);
            new ForgotPass();
